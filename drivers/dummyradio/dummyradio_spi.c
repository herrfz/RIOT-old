...
static uint8_t fifo_reg[] = {0x11, 0x41, 0xd8, 0x00, 0xfe, 0xca, 0xff, 0xff, 0x31, 0x34, 0x51, 0x10, 0x00, 0x59, 0x00, 0x6c, 0x00, 0x00};
static uint8_t beacon[] = {0x40, 0x40, 0xea, 0x00, 0xfe, 0xca, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xff, 0xa3, 0x05, 0x34, 0x06, 0x2f, 0x0a, 0x00, 0x00, 0x00, 0x00, 0x36, 0x23, 0x01, 0x01, 0x65, 0x00, 0x06, 0x01, 0x00, 0x00, 0x00, 0xf0, 0x02, 0x00, 0x00, 0x00, 0xe0, 0x03, 0x00, 0x00, 0x00, 0xe0, 0x04, 0x00, 0x00, 0x00, 0xe0, 0x05, 0x00, 0x00, 0x00, 0xe0, 0x06, 0x00, 0x00, 0x00, 0xe0, 0x00, 0x00};
static uint8_t irq_status, fifopointer = 0, bccount = 2;
int calls = 0;
...
void dummyradio_read_fifo(uint8_t *data, radio_packet_length_t length)
{
    if (bccount) { // first two calls for node are beacon length and beacon
        ...
        bccount--;
    } else { // ALWAYS receive KA in every slot
