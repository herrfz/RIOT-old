...
enum at86rf231_xah_ctrl_0 {
    AT86RF231_XAH_CTRL_0__MAX_FRAME_RETRES = 0xF0,
    AT86RF231_XAH_CTRL_0__MAX_CSMA_RETRES = 0x0E,
    AT86RF231_XAH_CTRL_0__SLOTTED_OPERATION = 0x01,
};
